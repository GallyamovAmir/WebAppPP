...
namespace WebAppPP.Controllers
{
    public class ProductCategoriesController : Controller
    {
        ...
        public ProductCategoriesController(VarkaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ProductCategories != null ? 
                          ...
                          Problem("Entity set 'VarkaDbContext.ProductCategories'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'VarkaDbContext.ProductCategories'  is null.");
            }
            var productCategory = await _context.ProductCategories.FindAsync(id);
            if (productCategory != null)
            {
