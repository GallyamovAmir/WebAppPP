...
namespace WebAppPP.Controllers
{
    ...
    {
        private readonly VarkaDbContext _context;

        public ProductsController(VarkaDbContext context)
        {
            _context = context;
        }
        ...
        {
            var varkaDbContext = _context.Products.Include(p => p.Category);
            return View(await varkaDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'VarkaDbContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
